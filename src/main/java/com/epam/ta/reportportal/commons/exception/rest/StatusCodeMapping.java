...
public class StatusCodeMapping {
	...
	private static final Map<ErrorType, HttpStatus> MAPPING = new HashMap<ErrorType, HttpStatus>() {
...

		{
			...
			put(ErrorType.UNABLE_TO_UPDATE_PERSONAL_PROJECT, HttpStatus.UNPROCESSABLE_ENTITY);
			put(ErrorType.UNABLE_TO_DELETE_PERSONAL_PROJECT, HttpStatus.UNPROCESSABLE_ENTITY);
